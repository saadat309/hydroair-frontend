...
export default function CartDrawer({ children }) {
  ...
  return (
    <Sheet>
      ...
      <SheetContent
        side="right"
        className="w-full sm:max-w-md flex flex-col p-0 bg-background border-l-border"
      >
                  ...
                  <div key={item.id} className="flex gap-4">
                    <div className="w-20 h-20 bg-secondary/20 rounded-lg flex items-center justify-center shrink-0 relative overflow-hidden">
                      {item.image ? (
                        ...
                        <span className="text-xs text-foreground p-1 text-center">
                          {item.name}
                        </span>
                      )}
                    </div>
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      <div className="flex justify-between items-start">
                        <h4 className="font-semibold text-foreground line-clamp-2 pr-2">
                          {item.name}
                        </h4>
                        <button
